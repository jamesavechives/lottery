...
use DB;
use Input;
class TjgeController extends Controller{
	...
	public function data(){
        ...
        $zero_number_arr   =array($last_data[0]->WAN,$last_data[0]->QIAN,$last_data[0]->BAI,$last_data[0]->SHI);
        $one_number_arr    =array($last_data[1]->WAN,$last_data[1]->QIAN,$last_data[1]->BAI,$last_data[1]->SHI);
        $two_number_arr    =array($last_data[2]->WAN,$last_data[2]->QIAN,$last_data[2]->BAI,$last_data[2]->SHI);
        $three_number_arr  =array($last_data[3]->WAN,$last_data[3]->QIAN,$last_data[3]->BAI,$last_data[3]->SHI);
        $four_number_arr   =array($last_data[4]->WAN,$last_data[4]->QIAN,$last_data[4]->BAI,$last_data[4]->SHI);
        $five_number_arr   =array($last_data[5]->WAN,$last_data[5]->QIAN,$last_data[5]->BAI,$last_data[5]->SHI);
        ...
        foreach ($data as $key => $value) {
            $number_arr = array($value->WAN,$value->QIAN,$value->BAI,$value->SHI);
            $eid = $value->EID;
            $qihao=$value->QIHAO;
            $number_str = $value->WAN.$value->QIAN.$value->BAI.$value->SHI;
            ...
            if($key == 0){
                ...
                Redis::command('HSET', ['yilouge', $eid, $expand]);
                
            }else{
                $last_number_arr      = array($data[$key-1]->WAN,$data[$key-1]->QIAN,$data[$key-1]->BAI,$data[$key-1]->SHI);
                //组选120的值
        ...
        for($na=1;$na<6;$na++){
           ...
           foreach (${'zxtj'.$na} as $key => $value) {
            ...
            Redis::command('HSET', ['zxtjge', 'zxtj'.$na, json_encode(${'zxtjn'.$na})]);
        }
        //升降屏
        for($nb=1;$nb<4;$nb++){
            //...............................................................1
           ...
           foreach (${'sjptj'.$nb} as $key => $value) {
            ...
            Redis::command('HSET', ['sjptjge', 'sjptj'.$nb, json_encode(${'sjptjn'.$nb})]);
           ...
           foreach (${'sjpjltj'.$nb} as $key => $value) {
            ...
            Redis::command('HSET', ['sjpjltjge', 'sjpjltj'.$nb, json_encode(${'sjpjltjn'.$nb})]);
            //.................................................................3
           ...
           foreach (${'sjpjlsjptj'.$nb} as $key => $value) {
            ...
            Redis::command('HSET', ['sjpjlsjptjge', 'sjpjlsjptj'.$nb, json_encode(${'sjpjlsjptjn'.$nb})]);
           //..................................................................4
           ...
           foreach (${'sjpjlsjp2tj'.$nb} as $key => $value) {
            ...
            Redis::command('HSET', ['sjpjlsjp2tjge', 'sjpjlsjp2tj'.$nb, json_encode(${'sjpjlsjp2tjn'.$nb})]);
           //...................................................................5
           ...
           foreach (${'sjp2tj'.$nb} as $key => $value) {
            ...
            Redis::command('HSET', ['sjp2tjge', 'sjp2tj'.$nb, json_encode(${'sjp2tjn'.$nb})]);
           //........................................................6
           ...
           foreach (${'jlsjptj'.$nb} as $key => $value) {
            ...
            Redis::command('HSET', ['jlsjptjge', 'jlsjptj'.$nb, json_encode(${'jlsjptjn'.$nb})]);
           //........................................................7
           ...
           Redis::command('HSET', ['jlsjpjltjge', 'jlsjpjltj'.$nb, json_encode(${'jlsjpjltjn'.$nb})]);
           //........................................................8
           ...
           foreach (${'jlsjpjlsjptj'.$nb} as $key => $value) {
            ...
            Redis::command('HSET', ['jlsjpjlsjptjge', 'jlsjpjlsjptj'.$nb, json_encode(${'jlsjpjlsjptjn'.$nb})]);
           //..............................................................9
         ...
         Redis::command('HSET', ['jlsjpjlsjp2tjge', 'jlsjpjlsjp2tj'.$nb, json_encode(${'jlsjpjlsjp2tjn'.$nb})]);
           //..............................................................10
           ...
           foreach (${'jlsjp2tj'.$nb} as $key => $value) {
            ...
            Redis::command('HSET', ['jlsjp2tjge', 'jlsjp2tj'.$nb, json_encode(${'jlsjp2tjn'.$nb})]);
           //..............................................................11
           ...
           foreach (${'jl2sjptj'.$nb} as $key => $value) {
            ...
            Redis::command('HSET', ['jl2sjptjge', 'jl2sjptj'.$nb, json_encode(${'jl2sjptjn'.$nb})]);
           //.............................................................12
         ...
         Redis::command('HSET', ['jl2sjp2tjge', 'jl2sjp2tj'.$nb, json_encode(${'jl2sjp2tjn'.$nb})]);
           //...............................................................13
           ...
           foreach (${'jl3sjptj'.$nb} as $key => $value) {
            ...
            Redis::command('HSET', ['jl3sjptjge', 'jl3sjptj'.$nb, json_encode(${'jl3sjptjn'.$nb})]);
           ...
           foreach (${'jl3sjp2tj'.$nb} as $key => $value) {
            ...
            Redis::command('HSET', ['jl3sjp2tjge', 'jl3sjp2tj'.$nb, json_encode(${'jl3sjp2tjn'.$nb})]);
           ...
           Redis::command('HSET', ['jl4sjptjge', 'jl4sjptj'.$nb, json_encode(${'jl4sjptjn'.$nb})]);
           //.............................................................16
           ...
           foreach (${'jl4sjp2tj'.$nb} as $key => $value) {
            ...
            Redis::command('HSET', ['jl4sjp2tjge', 'jl4sjp2tj'.$nb, json_encode(${'jl4sjp2tjn'.$nb})]);
           //...........................................................17
           ...
           Redis::command('HSET', ['qm012sjptjge', 'qm012sjptj'.$nb, json_encode(${'qm012sjptjn'.$nb})]);
           //............................................................18
           ...
           Redis::command('HSET', ['qm012sjp2tjge', 'qm012sjp2tj'.$nb, json_encode(${'qm012sjp2tjn'.$nb})]);
           //............................................................19
           ...
           foreach (${'qm012jlsjptj'.$nb} as $key => $value) {
            ...
            Redis::command('HSET', ['qm012jlsjptjge', 'qm012jlsjptj'.$nb, json_encode(${'qm012jlsjptjn'.$nb})]);
           //............................................................20
           ...
           foreach (${'qm012jlsjp2tj'.$nb} as $key => $value) {
            ...
            Redis::command('HSET', ['qm012jlsjp2tjge', 'qm012jlsjp2tj'.$nb, json_encode(${'qm012jlsjp2tjn'.$nb})]);
           //..........................................................21
           ...
           foreach (${'dxsjptj'.$nb} as $key => $value) {
            ...
            Redis::command('HSET', ['dxsjptjge', 'dxsjptj'.$nb, json_encode(${'dxsjptjn'.$nb})]);
           //..........................................................22
           ...
           foreach (${'dxsjp2tj'.$nb} as $key => $value) {
            ...
            Redis::command('HSET', ['dxsjp2tjge', 'dxsjp2tj'.$nb, json_encode(${'dxsjp2tjn'.$nb})]);
           //..........................................................23
           ...
           foreach (${'dxjlsjptj'.$nb} as $key => $value) {
            ...
            Redis::command('HSET', ['dxjlsjptjge', 'dxjlsjptj'.$nb, json_encode(${'dxjlsjptjn'.$nb})]);
           //..........................................................24
           ...
           foreach (${'dxjlsjp2tj'.$nb} as $key => $value) {
            ...
            Redis::command('HSET', ['dxjlsjp2tjge', 'dxjlsjp2tj'.$nb, json_encode(${'dxjlsjp2tjn'.$nb})]); 
        }
        ...
        for($nd=1;$nd<6;$nd++){
           ...
           foreach (${'jltj'.$nd} as $key => $value) {
            ...
            Redis::command('HSET', ['jltjge', 'jltj'.$nd, json_encode(${'jltjn'.$nd})]); 
        }
        for($nf=1;$nf<5;$nf++){
            //......................................................26
           ...
           foreach (${'jl2tj'.$nf} as $key => $value) {
            ...
            Redis::command('HSET', ['jl2tjge', 'jl2tj'.$nf, json_encode(${'jl2tjn'.$nf})]);  
        }
        for($nva=1;$nva<4;$nva++){
            //............................................................27
           ...
           Redis::command('HSET', ['jl3tjge', 'jl3tj'.$nva, json_encode(${'jl3tjn'.$nva})]); 
        }
       for($nv=1;$nv<4;$nv++){
           //..........................................................28
           ...
           foreach (${'qm012tj'.$nv} as $key => $value) {
            ...
            Redis::command('HSET', ['qm012tjge', 'qm012tj'.$nv , json_encode(${'qm012tjn'.$nv})]);
        ...
        Redis::command('HSET', ['dxtjge', 'dxtj'.$nv , json_encode(${'dxtjn'.$nv})]);
           //.........................................................30
           ...
           foreach (${'dxjltj'.$nv} as $key => $value) {
            ...
            Redis::command('HSET', ['dxjltjge', 'dxjltj'.$nv , json_encode(${'dxjltjn'.$nv})]);
           //.........................................................31
           ...
           foreach (${'qm012jltj'.$nv} as $key => $value) {
            ...
            Redis::command('HSET', ['qm012jltjge', 'qm012jltj'.$nv , json_encode(${'qm012jltjn'.$nv})]);
        }
        for($nt=1;$nt<3;$nt++){
            //........................................................32
           ...
           foreach (${'jl4tj'.$nt} as $key => $value) {
            ...
            Redis::command('HSET', ['jl4tjge', 'jl4tj'.$nt , json_encode(${'jl4tjn'.$nt})]);
        }
        //.............0
        ...
        Redis::command('HSET', ['tongjige', 'count', $counttj]);

       
        Redis::command('HSET', ['tongjige', 'zdyl', $zdyltj]);

        
         Redis::command('HSET', ['tongjige', 'pjyl', $pjyltj]);


      
        Redis::command('HSET', ['tongjige', 'zdlc', $zdlctj]);
