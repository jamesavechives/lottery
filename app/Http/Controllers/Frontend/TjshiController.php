...
use DB;
use Input;
class TjshiController extends Controller{
	...
	public function data(){
        ...
        $zero_number_arr   =array($last_data[0]->WAN,$last_data[0]->QIAN,$last_data[0]->BAI,$last_data[0]->GE);
        $one_number_arr    =array($last_data[1]->WAN,$last_data[1]->QIAN,$last_data[1]->BAI,$last_data[1]->GE);
        $two_number_arr    =array($last_data[2]->WAN,$last_data[2]->QIAN,$last_data[2]->BAI,$last_data[2]->GE);
        $three_number_arr  =array($last_data[3]->WAN,$last_data[3]->QIAN,$last_data[3]->BAI,$last_data[3]->GE);
        $four_number_arr   =array($last_data[4]->WAN,$last_data[4]->QIAN,$last_data[4]->BAI,$last_data[4]->GE);
        $five_number_arr   =array($last_data[5]->WAN,$last_data[5]->QIAN,$last_data[5]->BAI,$last_data[5]->GE);
        ...
        foreach ($data as $key => $value) {
            ...
            $number_arr = array($value->WAN,$value->QIAN,$value->BAI,$value->GE);
           
            $eid = $value->EID;
            $qihao=$value->QIHAO;
            
            $number_str = $value->WAN.$value->QIAN.$value->BAI.$value->GE;
            ...
            if($key == 0){
                ...
                Redis::command('HSET', ['yiloushi', $eid, $expand]);
               
                
            }else{
               
        $last_number_arr  = array($data[$key-1]->WAN,$data[$key-1]->QIAN,$data[$key-1]->BAI,$data[$key-1]->GE);
        ...
        for($na=1;$na<6;$na++){
           ...
           foreach (${'zxtj'.$na} as $key => $value) {
            ...
            Redis::command('HSET', ['zxtjshi', 'zxtj'.$na, json_encode(${'zxtjn'.$na})]);
        ...
        for($nb=1;$nb<4;$nb++){
           ...
           foreach (${'sjptj'.$nb} as $key => $value) {
            ...
            Redis::command('HSET', ['sjptjshi', 'sjptj'.$nb, json_encode(${'sjptjn'.$nb})]);
           ...
           foreach (${'sjpjltj'.$nb} as $key => $value) {
            ...
            Redis::command('HSET', ['sjpjltjshi', 'sjpjltj'.$nb, json_encode(${'sjpjltjn'.$nb})]);
        ...
        //Redis::command('HSET', ['sjpjlsjptjbai', 'sjpjlsjptj'.$nb, json_encode(${'sjpjlsjptjn'.$nb})]);
           Redis::command('HSET', ['sjpjlsjptjshi', 'sjpjlsjptj'.$nb, json_encode(${'sjpjlsjptjn'.$nb})]);
           ...
           //Redis::command('HSET', ['sjpjlsjp2tjqian', 'sjpjlsjp2tj'.$nb, json_encode(${'sjpjlsjp2tjn'.$nb})]);
            //Redis::command('HSET', ['sjpjlsjp2tjbai', 'sjpjlsjp2tj'.$nb, json_encode(${'sjpjlsjp2tjn'.$nb})]);
    Redis::command('HSET', ['sjpjlsjp2tjshi', 'sjpjlsjp2tj'.$nb, json_encode(${'sjpjlsjp2tjn'.$nb})]);
           ...
           //Redis::command('HSET', ['sjp2tjqian', 'sjp2tj'.$nb, json_encode(${'sjp2tjn'.$nb})]);
            //Redis::command('HSET', ['sjp2tjbai', 'sjp2tj'.$nb, json_encode(${'sjp2tjn'.$nb})]);
        Redis::command('HSET', ['sjp2tjshi', 'sjp2tj'.$nb, json_encode(${'sjp2tjn'.$nb})]);
           ...
           //Redis::command('HSET', ['jlsjptj', 'jlsjptj'.$nb, json_encode(${'jlsjptjn'.$nb})]);
            ...
            //Redis::command('HSET', ['jlsjptjbai', 'jlsjptj'.$nb, json_encode(${'jlsjptjn'.$nb})]);
        Redis::command('HSET', ['jlsjptjshi', 'jlsjptj'.$nb, json_encode(${'jlsjptjn'.$nb})]);
           ...
           //Redis::command('HSET', ['jlsjpjltj', 'jlsjpjltj'.$nb, json_encode(${'jlsjpjltjn'.$nb})]);
            ...
            //Redis::command('HSET', ['jlsjpjltjbai', 'jlsjpjltj'.$nb, json_encode(${'jlsjpjltjn'.$nb})]);
    Redis::command('HSET', ['jlsjpjltjshi', 'jlsjpjltj'.$nb, json_encode(${'jlsjpjltjn'.$nb})]);
           ...
           //Redis::command('HSET', ['jlsjpjlsjptj', 'jlsjpjlsjptj'.$nb, json_encode(${'jlsjpjlsjptjn'.$nb})]);
            ...
            //Redis::command('HSET', ['jlsjpjlsjptjbai', 'jlsjpjlsjptj'.$nb, json_encode(${'jlsjpjlsjptjn'.$nb})]);
    Redis::command('HSET', ['jlsjpjlsjptjshi', 'jlsjpjlsjptj'.$nb, json_encode(${'jlsjpjlsjptjn'.$nb})]);
        ...
        //Redis::command('HSET', ['jlsjpjlsjp2tjbai', 'jlsjpjlsjp2tj'.$nb, json_encode(${'jlsjpjlsjp2tjn'.$nb})]);
        Redis::command('HSET', ['jlsjpjlsjp2tjshi', 'jlsjpjlsjp2tj'.$nb, json_encode(${'jlsjpjlsjp2tjn'.$nb})]);
           ...
           //Redis::command('HSET', ['jlsjp2tj', 'jlsjp2tj'.$nb, json_encode(${'jlsjp2tjn'.$nb})]);
            ...
            //Redis::command('HSET', ['jlsjp2tjbai', 'jlsjp2tj'.$nb, json_encode(${'jlsjp2tjn'.$nb})]);
           Redis::command('HSET', ['jlsjp2tjshi', 'jlsjp2tj'.$nb, json_encode(${'jlsjp2tjn'.$nb})]);
           ...
           //Redis::command('HSET', ['jl2sjptj', 'jl2sjptj'.$nb, json_encode(${'jl2sjptjn'.$nb})]);
            ...
            //Redis::command('HSET', ['jl2sjptjbai', 'jl2sjptj'.$nb, json_encode(${'jl2sjptjn'.$nb})]);
        Redis::command('HSET', ['jl2sjptjshi', 'jl2sjptj'.$nb, json_encode(${'jl2sjptjn'.$nb})]);
           ...
           //Redis::command('HSET', ['jl2sjp2tjqian', 'jl2sjp2tj'.$nb, json_encode(${'jl2sjp2tjn'.$nb})]);
            //Redis::command('HSET', ['jl2sjp2tjbai', 'jl2sjp2tj'.$nb, json_encode(${'jl2sjp2tjn'.$nb})]);
            Redis::command('HSET', ['jl2sjp2tjshi', 'jl2sjp2tj'.$nb, json_encode(${'jl2sjp2tjn'.$nb})]);
        ...
        //Redis::command('HSET', ['jl3sjptjwan', 'jl3sjptj'.$nb, json_encode(${'jl3sjptjn'.$nb})]);
           //Redis::command('HSET', ['jl3sjptjqian', 'jl3sjptj'.$nb, json_encode(${'jl3sjptjn'.$nb})]);
            //Redis::command('HSET', ['jl3sjptjbai', 'jl3sjptj'.$nb, json_encode(${'jl3sjptjn'.$nb})]);
         Redis::command('HSET', ['jl3sjptjshi', 'jl3sjptj'.$nb, json_encode(${'jl3sjptjn'.$nb})]);
        ...
        //Redis::command('HSET', ['jl3sjp2tjwan', 'jl3sjp2tj'.$nb, json_encode(${'jl3sjp2tjn'.$nb})]);
           ...
           // Redis::command('HSET', ['jl3sjp2tjbai', 'jl3sjp2tj'.$nb, json_encode(${'jl3sjp2tjn'.$nb})]);
    Redis::command('HSET', ['jl3sjp2tjshi', 'jl3sjp2tj'.$nb, json_encode(${'jl3sjp2tjn'.$nb})]);
           ...
           //Redis::command('HSET', ['jl4sjptjwan', 'jl4sjptj'.$nb, json_encode(${'jl4sjptjn'.$nb})]);
            ...
            //Redis::command('HSET', ['jl4sjptjbai', 'jl4sjptj'.$nb, json_encode(${'jl4sjptjn'.$nb})]);
        Redis::command('HSET', ['jl4sjptjshi', 'jl4sjptj'.$nb, json_encode(${'jl4sjptjn'.$nb})]);
           ...
           //Redis::command('HSET', ['jl4sjp2tj', 'jl4sjp2tj'.$nb, json_encode(${'jl4sjp2tjn'.$nb})]);
            ...
            //Redis::command('HSET', ['jl4sjp2tjbai', 'jl4sjp2tj'.$nb, json_encode(${'jl4sjp2tjn'.$nb})]);
    Redis::command('HSET', ['jl4sjp2tjshi', 'jl4sjp2tj'.$nb, json_encode(${'jl4sjp2tjn'.$nb})]);
        ...
        //Redis::command('HSET', ['qm012sjptjbai', 'qm012sjptj'.$nb, json_encode(${'qm012sjptjn'.$nb})]);
    Redis::command('HSET', ['qm012sjptjshi', 'qm012sjptj'.$nb, json_encode(${'qm012sjptjn'.$nb})]);
           ...
           //Redis::command('HSET', ['qm012sjp2tj', 'qm012sjp2tj'.$nb, json_encode(${'qm012sjp2tjn'.$nb})]);
            ...
            //Redis::command('HSET', ['qm012sjp2tjbai', 'qm012sjp2tj'.$nb, json_encode(${'qm012sjp2tjn'.$nb})]);
        Redis::command('HSET', ['qm012sjp2tjshi', 'qm012sjp2tj'.$nb, json_encode(${'qm012sjp2tjn'.$nb})]);
        ...
        //Redis::command('HSET', ['qm012jlsjptjwan', 'qm012jlsjptj'.$nb, json_encode(${'qm012jlsjptjn'.$nb})]);
         //Redis::command('HSET', ['qm012jlsjptjqian', 'qm012jlsjptj'.$nb, json_encode(${'qm012jlsjptjn'.$nb})]);
            //Redis::command('HSET', ['qm012jlsjptjbai', 'qm012jlsjptj'.$nb, json_encode(${'qm012jlsjptjn'.$nb})]);
    Redis::command('HSET', ['qm012jlsjptjshi', 'qm012jlsjptj'.$nb, json_encode(${'qm012jlsjptjn'.$nb})]);
        ...
        //Redis::command('HSET', ['qm012jlsjp2tjqian', 'qm012jlsjp2tj'.$nb, json_encode(${'qm012jlsjp2tjn'.$nb})]);
            //Redis::command('HSET', ['qm012jlsjp2tjbai', 'qm012jlsjp2tj'.$nb, json_encode(${'qm012jlsjp2tjn'.$nb})]);
        Redis::command('HSET', ['qm012jlsjp2tjshi', 'qm012jlsjp2tj'.$nb, json_encode(${'qm012jlsjp2tjn'.$nb})]);
        ...
        //Redis::command('HSET', ['dxsjptjwan', 'dxsjptj'.$nb, json_encode(${'dxsjptjn'.$nb})]);
            ...
            //Redis::command('HSET', ['dxsjptjbai', 'dxsjptj'.$nb, json_encode(${'dxsjptjn'.$nb})]);
    Redis::command('HSET', ['dxsjptjshi', 'dxsjptj'.$nb, json_encode(${'dxsjptjn'.$nb})]);
        ...
        //Redis::command('HSET', ['dxsjp2tjqian', 'dxsjp2tj'.$nb, json_encode(${'dxsjp2tjn'.$nb})]);
            //Redis::command('HSET', ['dxsjp2tjbai', 'dxsjp2tj'.$nb, json_encode(${'dxsjp2tjn'.$nb})]);
        Redis::command('HSET', ['dxsjp2tjshi', 'dxsjp2tj'.$nb, json_encode(${'dxsjp2tjn'.$nb})]);
        ...
        //Redis::command('HSET', ['dxjlsjptjwan', 'dxjlsjptj'.$nb, json_encode(${'dxjlsjptjn'.$nb})]);
           ...
           // Redis::command('HSET', ['dxjlsjptjbai', 'dxjlsjptj'.$nb, json_encode(${'dxjlsjptjn'.$nb})]);
    Redis::command('HSET', ['dxjlsjptjshi', 'dxjlsjptj'.$nb, json_encode(${'dxjlsjptjn'.$nb})]);
        ...
        //Redis::command('HSET', ['dxjlsjp2tjwan', 'dxjlsjp2tj'.$nb, json_encode(${'dxjlsjp2tjn'.$nb})]); 
            ...
            //Redis::command('HSET', ['dxjlsjp2tjbai', 'dxjlsjp2tj'.$nb, json_encode(${'dxjlsjp2tjn'.$nb})]); 
        Redis::command('HSET', ['dxjlsjp2tjshi', 'dxjlsjp2tj'.$nb, json_encode(${'dxjlsjp2tjn'.$nb})]); 
        ...
        //Redis::command('HSET', ['jltjqian', 'jltj'.$nd, json_encode(${'jltjn'.$nd})]); 
           // Redis::command('HSET', ['jltjbai', 'jltj'.$nd, json_encode(${'jltjn'.$nd})]); 
        Redis::command('HSET', ['jltjshi', 'jltj'.$nd, json_encode(${'jltjn'.$nd})]); 
        ...
        //Redis::command('HSET', ['jl2tjwan', 'jl2tj'.$nf, json_encode(${'jl2tjn'.$nf})]);  
            ...
            //Redis::command('HSET', ['jl2tjbai', 'jl2tj'.$nf, json_encode(${'jl2tjn'.$nf})]);  
    Redis::command('HSET', ['jl2tjshi', 'jl2tj'.$nf, json_encode(${'jl2tjn'.$nf})]);  
        ...
        //Redis::command('HSET', ['jl3tjwan', 'jl3tj'.$nva, json_encode(${'jl3tjn'.$nva})]); 
           //Redis::command('HSET', ['jl3tjqian', 'jl3tj'.$nva, json_encode(${'jl3tjn'.$nva})]); 
            //Redis::command('HSET', ['jl3tjbai', 'jl3tj'.$nva, json_encode(${'jl3tjn'.$nva})]); 
    Redis::command('HSET', ['jl3tjshi', 'jl3tj'.$nva, json_encode(${'jl3tjn'.$nva})]); 
       ...
       for($nv=1;$nv<4;$nv++){
        ...
        //Redis::command('HSET', ['qm012tjwan', 'qm012tj'.$nv , json_encode(${'qm012tjn'.$nv})]);
            ...
            //Redis::command('HSET', ['qm012tjbai', 'qm012tj'.$nv , json_encode(${'qm012tjn'.$nv})]);
   Redis::command('HSET', ['qm012tjshi', 'qm012tj'.$nv , json_encode(${'qm012tjn'.$nv})]);
        ...
        //Redis::command('HSET', ['dxtjwan', 'dxtj'.$nv , json_encode(${'dxtjn'.$nv})]);
            ...
            //Redis::command('HSET', ['dxtjbai', 'dxtj'.$nv , json_encode(${'dxtjn'.$nv})]);
        Redis::command('HSET', ['dxtjshi', 'dxtj'.$nv , json_encode(${'dxtjn'.$nv})]);
        ...
        //Redis::command('HSET', ['dxjltjqian', 'dxjltj'.$nv , json_encode(${'dxjltjn'.$nv})]);
            //Redis::command('HSET', ['dxjltjbai', 'dxjltj'.$nv , json_encode(${'dxjltjn'.$nv})]);
        Redis::command('HSET', ['dxjltjshi', 'dxjltj'.$nv , json_encode(${'dxjltjn'.$nv})]);
           ...
           //Redis::command('HSET', ['qm012jltj', 'qm012jltj'.$nv , json_encode(${'qm012jltjn'.$nv})]);
            ...
            //Redis::command('HSET', ['qm012jltjbai', 'qm012jltj'.$nv , json_encode(${'qm012jltjn'.$nv})]);
             Redis::command('HSET', ['qm012jltjshi', 'qm012jltj'.$nv , json_encode(${'qm012jltjn'.$nv})]);
        ...
        //Redis::command('HSET', ['jl4tjwan', 'jl4tj'.$nt , json_encode(${'jl4tjn'.$nt})]);
            ...
            //Redis::command('HSET', ['jl4tjbai', 'jl4tj'.$nt , json_encode(${'jl4tjn'.$nt})]);
        Redis::command('HSET', ['jl4tjshi', 'jl4tj'.$nt , json_encode(${'jl4tjn'.$nt})]);
        ...
        //Redis::command('HSET', ['tongji', 'count', $counttj]);
         ...
         //Redis::command('HSET', ['tongjibai', 'count', $counttj]);
        Redis::command('HSET', ['tongjishi', 'count', $counttj]);
        ...
        //Redis::command('HSET', ['tongji', 'zdyl', $zdyltj]);
         ...
         //Redis::command('HSET', ['tongjibai', 'zdyl', $zdyltj]);
    Redis::command('HSET', ['tongjishi', 'zdyl', $zdyltj]);
        ...
        //Redis::command('HSET', ['tongjibai', 'pjyl', $pjyltj]);
            Redis::command('HSET', ['tongjishi', 'pjyl', $pjyltj]);
    ...
    //Redis::command('HSET', ['tongjiwan', 'zdlc', $zdlctj]);
        ...
        //Redis::command('HSET', ['tongjibai', 'zdlc', $zdlctj]);
    Redis::command('HSET', ['tongjishi', 'zdlc', $zdlctj]);
