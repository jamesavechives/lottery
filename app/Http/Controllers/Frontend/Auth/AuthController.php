...
class AuthController extends Controller{
    ...
    public function __construct(AuthenticationContract $auth){
        ...
        $this->auth = $auth;
        $this->middleware('reg', ['only' => ['postRegister']]);
        //$this->middleware('login', ['only' => ['postLogin']]);
        $this->middleware('logined', ['only' => ['postLogin']]);
    }
    ...
    public function postRegister(RegisterRequest $request){
        ...
        if (config('access.users.confirm_email')) {
            ...
            return redirect()->route('home')->withFlashSuccess('账户创建成功. 已经发送邮件.');
        } else {
    ...
    public function confirmAccount($token){
        ...
        return redirect()->to('auth/login')->withFlashSuccess('你的账户已确认!');
    }
    ...
    public function resendConfirmationEmail($user_id){
        ...
        try {
            ...
            return redirect()->route('home')->withFlashSuccess('确认邮件已经发送.');
        } catch (GeneralException $e) {
            return redirect()->back()->withInput()->withFlashDanger($e->getMessage());
        }
    }
