...
use DB;
use Input;
class TjwanController extends Controller{
	...
	public function data(){
        ...
        $zero_number_arr   =array($last_data[0]->QIAN,$last_data[0]->BAI,$last_data[0]->SHI,$last_data[0]->GE);
        $one_number_arr    =array($last_data[1]->QIAN,$last_data[1]->BAI,$last_data[1]->SHI,$last_data[1]->GE);
        $two_number_arr    =array($last_data[2]->QIAN,$last_data[2]->BAI,$last_data[2]->SHI,$last_data[2]->GE);
        $three_number_arr  =array($last_data[3]->QIAN,$last_data[3]->BAI,$last_data[3]->SHI,$last_data[3]->GE);
        $four_number_arr   =array($last_data[4]->QIAN,$last_data[4]->BAI,$last_data[4]->SHI,$last_data[4]->GE);
        $five_number_arr   =array($last_data[5]->QIAN,$last_data[5]->BAI,$last_data[5]->SHI,$last_data[5]->GE);
