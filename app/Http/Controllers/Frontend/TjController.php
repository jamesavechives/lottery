...
class TjController extends Controller{
	...
	public function data(){
        ...
        print_r($last_data);
        die();
        $zero_number_arr   =array($last_data[0]->WAN,$last_data[0]->QIAN,$last_data[0]->BAI,$last_data[0]->SHI,$last_data[0]->GE);
        $one_number_arr    =array($last_data[1]->WAN,$last_data[1]->QIAN,$last_data[1]->BAI,$last_data[1]->SHI,$last_data[1]->GE);
        $two_number_arr    =array($last_data[2]->WAN,$last_data[2]->QIAN,$last_data[2]->BAI,$last_data[2]->SHI,$last_data[2]->GE);
        $three_number_arr  =array($last_data[3]->WAN,$last_data[3]->QIAN,$last_data[3]->BAI,$last_data[3]->SHI,$last_data[3]->GE);
        $four_number_arr   =array($last_data[4]->WAN,$last_data[4]->QIAN,$last_data[4]->BAI,$last_data[4]->SHI,$last_data[4]->GE);
        $five_number_arr   =array($last_data[5]->WAN,$last_data[5]->QIAN,$last_data[5]->BAI,$last_data[5]->SHI,$last_data[5]->GE);

        $dxjlsjp2yl=array(); $dxjlsjpyl =array(); $dxjlyl =array(); $dxsjp2yl = array();
        $dxsjpyl=array(); $dxyl=array(); $qm012jlsjp2yl=array(); $qm012jlsjpyl=array();
        $qm012jlyl=array();$qm012sjp2yl=array();$qm012sjpyl=array();$qm012yl=array();
        $jl4sjp2yl=array();$jl4sjpyl=array();$jl4yl=array();$jl3sjp2yl=array();
        $jl3sjpyl=array(); $jl3yl=array(); $jl2sjp2yl=array();$jl2sjpyl=array();
        $jl2yl=array();$jlsjp2yl=array();$jlsjpyl=array();$jlyl=array();
        $sjpyl2 = array(); $sjpyl = array();$one = array();$jlsjpjlyl=array();
        $jlsjpjlsjpyl=array();$jlsjpjlsjp2yl=array(); $sjpjlyl=array();
        $sjpjlsjpyl=array();$sjpjlsjp2yl=array();
        $zxtj='zxtj';
        ...
        foreach ($data as $key => $value) {
            ...
            if($key == 0){
                ...
                $sjp_jl2_res          = self::jl_info($sjp_jl_res ,$last_sjp_jl_res);
                $sjp_jl_arr[]         = $sjp_jl_res;
                $sjp_jl2_arr[]         = $sjp_jl2_res;
                for($a=0; $a<3; $a++){
