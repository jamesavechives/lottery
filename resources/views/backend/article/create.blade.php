    ...
    <div class="box box-success">
        ...
        <div class="box-body">
            <div class="form-group">
                ...
                <div class="col-lg-12">
                    {!! Form::text('title', null, ['class' => 'form-control', 'placeholder' => trans('strings.article.name')]) !!}
                </div>
            </div>
            <div class="form-group">
                {!! Form::label('desc', trans('validation.article.desc'), ['class' => 'col-lg-12 text-left']) !!}
                <div class="col-lg-12">
                    {!! Form::text('desc', null, ['class' => 'form-control', 'placeholder' => trans('strings.article.desc')]) !!}
                </div>
            </div>
            <div class="form-group">
                {!! Form::label('category_id', '分类：', ['class' => 'col-md-1 text-left']) !!}
                <div class="col-md-11">
                    {!! Form::select('category_id', $cat,['class'=>'form-control']) !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-12">
                    {!! Form::textarea('content', '请在这里输入内容！', ['class' => 'form-control', 'id' => 'summernote', 'placeholder' => 'Hello Summernote']) !!}
                </div>
                <script>
