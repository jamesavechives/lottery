    ...
    {!! Form::model($user, ['route' => ['admin.access.users.update', $user->id], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH']) !!}
        ...
        <div class="box box-success">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    {!! Form::label('truename', trans('validation.attributes.truename'), ['class' => 'col-lg-2 control-label']) !!}
                    <div class="col-lg-10">
                        {!! Form::text('truename', null, ['class' => 'form-control', 'placeholder' => trans('validation.attributes.truename')]) !!}
                    </div>
                </div><!--form control-->
                ...
                <div class="form-group">
                    {!! Form::label('phone', trans('validation.attributes.phone'), ['class' => 'col-lg-2 control-label']) !!}
                    <div class="col-lg-10">
                        {!! Form::text('phone', null, ['class' => 'form-control', 'placeholder' => trans('validation.attributes.phone')]) !!}
                    </div>
                </div><!--form control-->
                <div class="form-group">
                    {!! Form::label('qq', trans('validation.attributes.qq'), ['class' => 'col-lg-2 control-label']) !!}
                    <div class="col-lg-10">
                        {!! Form::text('qq', null, ['class' => 'form-control', 'placeholder' => trans('validation.attributes.qq')]) !!}
                    </div>
                </div><!--form control-->

                <div class="form-group">
                    {!! Form::label('watch', trans('validation.attributes.watch'), ['class' => 'col-lg-2 control-label']) !!}
                    <div class="col-lg-10">
                        {!! Form::text('watch', null, ['class' => 'form-control', 'placeholder' => trans('validation.attributes.watch')]) !!}
                    </div>
                </div><!--form control-->

                @if ($user->id != 1)
                    <div class="form-group">
                        {!! Form::label('gold', trans('validation.attributes.gold'), ['class' => 'col-lg-2 control-label']) !!}
                        <div class="col-lg-10">
                            {!! Form::text('gold', null, ['class' => 'form-control', 'placeholder' => trans('validation.attributes.gold')]) !!}
                        </div>
                    </div><!--form control-->

                    <div class="form-group">
                        {!! Form::label('gold_end_time', '到期日', ['class' => 'col-lg-2 control-label']) !!}
                        <div class="col-lg-10">
                            {!! Form::text('gold_end_time', '', ['class' => 'form-control','id' => 'wish_begin','placeholder' => '若会员为按次数扣除金币者，可不用选择此到期日']) !!}
                        </div>
                    </div><!--form control-->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <div class="alert alert-info">
                                <i class="fa fa-info-circle"></i> 请选择权限.
                            </div><!--alert-->
