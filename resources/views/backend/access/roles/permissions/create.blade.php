                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane" id="dependencies" style="padding-top:20px">
                            ...
                            <div class="alert alert-info">
                                <i class="fa fa-info-circle"></i> 创建权限，指定此权限是否有一个或多个其他权限相关联.<br/><br/>
                                例如: 创建一个权限 <strong>create-user</strong>, 但是此会员没有 <strong>view-backend</strong> 和 <strong>view-access-management</strong> 权限 ，则他们将无法创建 <strong>Create User</strong> .
                            </div><!--alert-->
