...
@section('content')
    {!! Form::open(['route' => 'admin.wishes.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post']) !!}
    <div class="box box-success">
        ...
        <div class="box-body">
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => trans('strings.wishes.name')]) !!}
                </div>
            </div>
            <div class="form-group">
                {!! Form::label('begin', '开始日期:',['class' => 'col-lg-2 text-left']) !!}
                <div class="col-lg-10">
                    {!! Form::text('begin', date('Y-m-d'), ['class' => 'form-control','id' => 'wish_begin']) !!}
                </div>
            </div>
            <div class="form-group">
                {!! Form::label('end', '结束日期:',['class' => 'col-lg-2 text-left']) !!}
                <div class="col-lg-10">
                {!! Form::text('end', date('Y-m-d'), ['class' => 'form-control','id' => 'wish_end']) !!}
                </div>
            </div>
            <div class="form-group">
                {!! Form::label('content', trans('validation.wishes.content'), ['class' => 'col-lg-12 text-left']) !!}
                <div class="col-lg-12">
                    {!! Form::textarea('content', '', ['class' => 'form-control', 'id' => 'summernote']) !!}
                </div>
                <script>
