...
@section ('title', trans('menus.category_management') . ' | ' . trans('menus.create_category'))
    ...
    <div class="box box-success">
        ...
        <div class="box-body">
            <div class="form-group">
                ...
                <div class="col-lg-12">
                    {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => trans('strings.category.name')]) !!}
                </div>
            </div>
            <div class="form-group">
                {!! Form::label('desc', trans('validation.category.desc'), ['class' => 'col-lg-12 text-left']) !!}
                <div class="col-lg-12">
                    {!! Form::text('desc', null, ['class' => 'form-control', 'placeholder' => trans('strings.category.desc')]) !!}
                </div>
            </div>
        </div><!-- /.box-body -->
    </div><!--box-->
