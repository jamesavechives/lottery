...
@section('witch-js-need')
    ...
    <script src="{{asset('frontend/js/sjp.content.js')}}"></script>
...
$(document).ready(function(){
    $("#fuzhi").zclip({
       	path:'{!! asset('frontend/js/ZeroClipboard.swf') !!}', 
        copy:function(){
            return $('#zx120tjdata').val();
        },
    	...
    	<table id="zuxuan120">
     		<thead>
      			<tr class="gongtr">
		       		...
		       		<td rowspan="2" class="fqtds"></td>
		       		<th colspan="6"  id="about120"><div class="about120_div">组选120</div></th>
		       		...
		       		<th colspan="3" class="nimeide">升降平</th> --> 
		       		<td class='fqtds'><div class='xian'></div></td>
		       		<th colspan="6" class="jlshowoff wojian1"><div class="jls0">距离</div></th>
		       		...
		       		<th colspan="3" class="jl2showoff"><div class="sjp0">升降平</div></th>
		       		<td class='fqtds'><div class='xian'></div></td>
		       		<th colspan="4" class="jl3showoff wojian3"><div class="jls2">距离三</div></th>
		       		<th colspan="3" class="jl3showoff"><div class="sjp0">升降平</div></th>
		       		<th colspan="3"  class="jl3showoff"><div class="sjp0">升降平</div></th>
		       		<td class='fqtds'><div class='xian'></div></td>
		       		<th colspan="3"  class="jl4showoff wojian4"><div class="jls3">距离四</div></th>
      			...
      			<tr class="gongtr">
		       		<td class="zx120 " id="n120">120</td>
		       		<td class="zx120 " id="n60">60</td>
		       		<td class="zx120 " id="n30">30</td>
		       		<td class="zx120 " id="n20">20</td>
		       		<td class="zx120 " id="n10">10</td>
		       		<td class="zx120 qudiaos" id="aubout26">5</td>
		       		<td class='fqtds'><div class='xian'></div></td>
		       		<!--升降屏-->
		       		...
		       		<td class="jlinfo jlshowoff">4</td>
		       		<td class="jlinfo qudiaos jlshowoff">5</td>
		       		...
		       		<td class='fqtds'><div class='xian'></div></td>
		       		<!--距离的距离-->
		       		<td class="jlinfo jl2showoff">0</td>
		       		<td class="jlinfo jl2showoff">1</td>
		       		<td class="jlinfo jl2showoff">2</td>
		       		<td class="jlinfo jl2showoff">3</td>
		       		<td class="jlinfo jl2showoff qudiaos">4</td>
		       		...
		       		<td class='fqtds'><div class='xian'></div></td>
		       		<!--距离的距离的距离-->
		       		<td class="jlinfo jl3showoff">0</td>
		       		<td class="jlinfo jl3showoff">1</td>
		       		<td class="jlinfo jl3showoff">2</td>
		       		<td class="jlinfo jl3showoff qudiaos">3</td>
		       		...
		       		<td class='fqtds'><div class='xian'></div></td>
		       		<!--距离的距离的距离的距离-->
		       		<td class="jlinfo jl4showoff">0</td>
		       		<td class="jlinfo jl4showoff">1</td>
		       		<td class="jlinfo jl4showoff qudiaos">2</td>
    		...
    		<tfoot>
    			<tr class="yuce gongtr yuceone">
					...
					<td data-yuce ='5' class="scycsjp bs10"></td>
					<td data-yuce ='6' class="scycsjp qudiaos bs5"></td>
					<td class='fqtds'><div class='xian'></div></td>
  		...
  		<table id="data-tab-sjp2">
  			<thead>
  				<tr>
  					<th colspan="9" class="sjpjlinfos" style="height:25px;"> 升降平距离信息 </th>
  				</tr>
  				<tr>
  					<th colspan="3" class="sjpjlinfos">距离</th>
  					<th colspan="3" class="sjpjlinfos">升降平</th>
  					<th colspan="3" class="sjpjlinfos">升降平</th>
  				</tr>
  			</thead>
  		</table>

  		<table id="data-tab-sjp3">
  			<thead>
  				<tr>
  					<th colspan="9" class="jlsjpjlinfos" style="height:25px;"> 距离升降平距离信息 </th>
  				</tr>
  				<tr>
  					<th colspan="3" class="jlsjpjlinfos">距离</th>
  					<th colspan="3" class="jlsjpjlinfos">升降平</th>
  					<th colspan="3" class="jlsjpjlinfos">升降平</th>
  				</tr>
  			</thead>
  		</table>
	...
	<div class="ma">
		<div class="maxia">
			<ul class="u2" style="padding-top:0px;">
				<li> 
					<input type="checkbox" class="zx120quanxuan" name='zx120quxuan' value = "all"  />&nbsp;全选
				</li>
				<li> 
					<input type="checkbox" class="zx120yssj" name='zx120yssj' value = "0"  />&nbsp;120
				</li>
				<li> 
					<input type="checkbox" class="zx120yssj" name='zx120yssj' value = "1"  />&nbsp;60
				</li>
				<li> 
					<input type="checkbox" class="zx120yssj" name='zx120yssj' value = "2"  />&nbsp;30 
				</li>
				<li> 
					<input type="checkbox" class="zx120yssj" name='zx120yssj' value = "3"  />&nbsp;20
				</li>
				<li> 
					<input type="checkbox" class="zx120yssj" name='zx120yssj' value = "4"  />&nbsp;10 
				</li>
				<li> 
					<input type="checkbox" class="zx120yssj" name='zx120yssj' value = "5"  />&nbsp;5 
				</li>
		    </ul>
		    <ul class="u23" style="padding-top:0px;">
				<li> 
					<input type="checkbox" class="zx120quanxuan" name='zx24quxuan' value = "all"  />&nbsp;全选
				</li>
				<li> 
					<input type="checkbox" class="zx120yssj" name='zx24yssj' value = "0"  />&nbsp;24
				</li>
				<li> 
					<input type="checkbox" class="zx120yssj" name='zx24yssj' value = "1"  />&nbsp;12
				</li>
				<li> 
					<input type="checkbox" class="zx120yssj" name='zx24yssj' value = "2"  />&nbsp;6 
				</li>
				<li> 
					<input type="checkbox" class="zx120yssj" name='zx24yssj' value = "3"  />&nbsp;4
				</li>
				<li> 
					<input type="checkbox" class="zx120yssj" name='zx24yssj' value = "4"  />&nbsp;2 
				</li>
		    </ul>
		    <div style="clear:both;"></div>
			<div class="copynum">
