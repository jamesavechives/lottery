...
@section('witch-js-need')
    <script src="{{asset('frontend/js/ajaxlivearr.js')}}"></script>
    <script src="{{asset('frontend/js/myapp.js')}}"></script>
    <script src="{{asset('frontend/js/livearr.content.js')}}"></script>
@endsection
@section('header')
            ...
            <div class="zst_all">
                <table id="zuxuan120">
                    ...
                    <tr class="gongtrlive">
                        ...
                        <td rowspan="2" class="fqtds"></td>
                        <th colspan="4"  id="about120"><div class="about120live_div">数组</div></th>
                        ...
                        <th colspan="3" class="nimeide">升降平</th> -->
                        <td class='fqtds'><div class='xian'></div></td>
                        <th colspan="4" class="jlshowoff wojian1"><div class="jls0">距离</div></th>
                        ...
                        <th colspan="3" class="nimeide2">升降平</th> -->
                        <td class='fqtds'><div class='xian'></div></td>
                        <th colspan="4" class="jl2showoff wojian2"><div class="jls1">距离的距离</div></th>
                        ...
                        <th colspan="3"  class="jl3showoff"><div class="sjp0">升降平</div></th>
                        <td class='fqtds'><div class='xian'></div></td>
                        <th colspan="4"  class="jl4showoff wojian4"><div class="jls3">距离四</div></th>
                    ...
                    <tr class="gongtrlive">
                        <td class="zx120 " id="alive">A</td>
                        <td class="zx120 " id="blive">B</td>
                        <td class="zx120 " id="clive">C</td>
                        <td class="zx120 " id="dlive">D</td>
                        <td class='fqtds'><div class='xian'></div></td>
                        <!--升降屏-->
                        ...
                        <td class="jlinfo qudiaos jlshowoff">3</td>
                    ...
                    <tbody id="data-tab-livearr" class="">
                    </tbody>
                    <tfoot>
                    <tr class="yuce gongtr yuceone">
                        ...
                        <td data-yuce ='4' class="scycsjp qudiaos bs4"></td>
                        <td class='fqtds'><div class='xian'></div></td>
                    ...
                    <tr class="tingji gongtr livearr-tjf">
                    ...
                    <tr class="tongji gongtr livearr-tjf">
                ...
                <table id="data-tab-livearr-sjp2">
                    <thead>
                    <tr>
                ...
                <table id="data-tab-livearr-sjp3">
                    <thead>
                    <tr>
